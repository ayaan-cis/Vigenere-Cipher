...
public class VigenereCipher_TestCasesSubset_1_ENVIRONMENT
{
	//STUDENT: YOU *MUST* CHANGE THE VALUE OF LAST_NAME
	public static final String LAST_NAME = "Syed";
	...
	public void correctClassNamePrefix()
	{
		...
		String actualClassName = getClassNameWithoutPackage(VigenereCipher_Syed.class);
	...
	public void correctPackageTest()
	{
		...
		String actualPackageName = VigenereCipher_Syed.class.getPackageName();
